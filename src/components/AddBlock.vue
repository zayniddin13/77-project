<template>
  <div
    class="mt-6 max-h-32 rounded-xl border border-white shadow-anounce bg-white flex gap-1 font-inter leading-6 relative"
  >
    ...
    <img
      :src="image"
      alt="good pruduct"
      class="w-40  max-h-32  rounded-l-xl object-cover"
    />
    <div class="sm:p-5 p-2 !truncate">
      <div
